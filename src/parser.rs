...
impl Parser {
    fn initialize(&mut self) {
		...
		self.goto.insert(21, GotoNode{token_type: TokenType::StatementFunction, value: 8});
		...
		self.action.insert((0, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 14});
		...
		self.action.insert((3, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 14});
		...
		self.action.insert((14, TokenType::StatementExpression), ActionNode{action: ParserAction::Goto, value: 28});
		self.action.insert((14, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 30});
		self.action.insert((14, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 32});
		self.action.insert((14, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 33});
		self.action.insert((14, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 29});
		self.action.insert((14, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 31});
		self.action.insert((15, TokenType::StatementExpressionP), ActionNode{action: ParserAction::Goto, value: 34});
		self.action.insert((15, TokenType::At), ActionNode{action: ParserAction::Reduce, value: 26});
		self.action.insert((15, TokenType::While), ActionNode{action: ParserAction::Reduce, value: 26});
		self.action.insert((15, TokenType::For), ActionNode{action: ParserAction::Reduce, value: 26});
		self.action.insert((15, TokenType::If), ActionNode{action: ParserAction::Reduce, value: 26});
		self.action.insert((15, TokenType::Identifier), ActionNode{action: ParserAction::Reduce, value: 26});
		self.action.insert((15, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 36});
		self.action.insert((15, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Reduce, value: 26});
		self.action.insert((15, TokenType::Term), ActionNode{action: ParserAction::Reduce, value: 26});
		self.action.insert((15, TokenType::Newline), ActionNode{action: ParserAction::Reduce, value: 26});
		self.action.insert((15, TokenType::Add), ActionNode{action: ParserAction::Shift, value: 35});
		self.action.insert((16, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 37});
		self.action.insert((16, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 18});
		self.action.insert((16, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 14});
		self.action.insert((16, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 16});
		self.action.insert((17, TokenType::StatementExpression2p), ActionNode{action: ParserAction::Goto, value: 38});
		self.action.insert((17, TokenType::Subtract), ActionNode{action: ParserAction::Reduce, value: 30});
		self.action.insert((17, TokenType::Add), ActionNode{action: ParserAction::Reduce, value: 30});
		self.action.insert((17, TokenType::At), ActionNode{action: ParserAction::Reduce, value: 30});
		self.action.insert((17, TokenType::While), ActionNode{action: ParserAction::Reduce, value: 30});
		self.action.insert((17, TokenType::For), ActionNode{action: ParserAction::Reduce, value: 30});
		self.action.insert((17, TokenType::If), ActionNode{action: ParserAction::Reduce, value: 30});
		self.action.insert((17, TokenType::Identifier), ActionNode{action: ParserAction::Reduce, value: 30});
		self.action.insert((17, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Reduce, value: 30});
		self.action.insert((17, TokenType::Term), ActionNode{action: ParserAction::Reduce, value: 30});
		self.action.insert((17, TokenType::Newline), ActionNode{action: ParserAction::Reduce, value: 30});
		self.action.insert((17, TokenType::Multiply), ActionNode{action: ParserAction::Shift, value: 39});
		self.action.insert((17, TokenType::Divide), ActionNode{action: ParserAction::Shift, value: 40});
		self.action.insert((17, TokenType::Modulo), ActionNode{action: ParserAction::Shift, value: 41});
		self.action.insert((18, TokenType::Modulo), ActionNode{action: ParserAction::Reduce, value: 34});
		self.action.insert((18, TokenType::Divide), ActionNode{action: ParserAction::Reduce, value: 34});
		self.action.insert((18, TokenType::Multiply), ActionNode{action: ParserAction::Reduce, value: 34});
		self.action.insert((18, TokenType::Subtract), ActionNode{action: ParserAction::Reduce, value: 34});
		self.action.insert((18, TokenType::Add), ActionNode{action: ParserAction::Reduce, value: 34});
		self.action.insert((18, TokenType::At), ActionNode{action: ParserAction::Reduce, value: 34});
		self.action.insert((18, TokenType::While), ActionNode{action: ParserAction::Reduce, value: 34});
		self.action.insert((18, TokenType::For), ActionNode{action: ParserAction::Reduce, value: 34});
		self.action.insert((18, TokenType::If), ActionNode{action: ParserAction::Reduce, value: 34});
		self.action.insert((18, TokenType::Identifier), ActionNode{action: ParserAction::Reduce, value: 34});
		self.action.insert((18, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Reduce, value: 34});
		self.action.insert((18, TokenType::Term), ActionNode{action: ParserAction::Reduce, value: 34});
		self.action.insert((18, TokenType::Newline), ActionNode{action: ParserAction::Reduce, value: 34});
		...
		self.action.insert((26, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 48});
		...
		self.action.insert((27, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 15});
		self.action.insert((27, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 17});
		self.action.insert((27, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 18});
		self.action.insert((27, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 14});
		self.action.insert((27, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 16});
		self.action.insert((28, TokenType::RightParenthesis), ActionNode{action: ParserAction::Shift, value: 51});
		self.action.insert((29, TokenType::StatementExpression), ActionNode{action: ParserAction::Goto, value: 52});
		self.action.insert((29, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 30});
		self.action.insert((29, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 32});
		self.action.insert((29, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 33});
		self.action.insert((29, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 29});
		self.action.insert((29, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 31});
		self.action.insert((30, TokenType::StatementExpressionP), ActionNode{action: ParserAction::Goto, value: 53});
		self.action.insert((30, TokenType::RightParenthesis), ActionNode{action: ParserAction::Reduce, value: 26});
		self.action.insert((30, TokenType::Add), ActionNode{action: ParserAction::Shift, value: 54});
		self.action.insert((30, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 55});
		self.action.insert((31, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 56});
		self.action.insert((31, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 33});
		self.action.insert((31, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 29});
		self.action.insert((31, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 31});
		self.action.insert((32, TokenType::StatementExpression2p), ActionNode{action: ParserAction::Goto, value: 57});
		self.action.insert((32, TokenType::Subtract), ActionNode{action: ParserAction::Reduce, value: 30});
		self.action.insert((32, TokenType::Add), ActionNode{action: ParserAction::Reduce, value: 30});
		self.action.insert((32, TokenType::RightParenthesis), ActionNode{action: ParserAction::Reduce, value: 30});
		self.action.insert((32, TokenType::Multiply), ActionNode{action: ParserAction::Shift, value: 58});
		self.action.insert((32, TokenType::Divide), ActionNode{action: ParserAction::Shift, value: 59});
		self.action.insert((32, TokenType::Modulo), ActionNode{action: ParserAction::Shift, value: 60});
		self.action.insert((33, TokenType::Modulo), ActionNode{action: ParserAction::Reduce, value: 34});
		self.action.insert((33, TokenType::Divide), ActionNode{action: ParserAction::Reduce, value: 34});
		self.action.insert((33, TokenType::Multiply), ActionNode{action: ParserAction::Reduce, value: 34});
		self.action.insert((33, TokenType::Subtract), ActionNode{action: ParserAction::Reduce, value: 34});
		self.action.insert((33, TokenType::Add), ActionNode{action: ParserAction::Reduce, value: 34});
		self.action.insert((33, TokenType::RightParenthesis), ActionNode{action: ParserAction::Reduce, value: 34});
		self.action.insert((34, TokenType::At), ActionNode{action: ParserAction::Reduce, value: 25});
		self.action.insert((34, TokenType::While), ActionNode{action: ParserAction::Reduce, value: 25});
		self.action.insert((34, TokenType::For), ActionNode{action: ParserAction::Reduce, value: 25});
		self.action.insert((34, TokenType::If), ActionNode{action: ParserAction::Reduce, value: 25});
		self.action.insert((34, TokenType::Identifier), ActionNode{action: ParserAction::Reduce, value: 25});
		self.action.insert((34, TokenType::Subtract), ActionNode{action: ParserAction::Reduce, value: 25});
		self.action.insert((34, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Reduce, value: 25});
		self.action.insert((34, TokenType::Term), ActionNode{action: ParserAction::Reduce, value: 25});
		self.action.insert((34, TokenType::Newline), ActionNode{action: ParserAction::Reduce, value: 25});
		self.action.insert((35, TokenType::StatementExpression), ActionNode{action: ParserAction::Goto, value: 61});
		self.action.insert((35, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 15});
		self.action.insert((35, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 17});
		self.action.insert((35, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 18});
		self.action.insert((35, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 14});
		self.action.insert((35, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 16});
		self.action.insert((36, TokenType::StatementExpression), ActionNode{action: ParserAction::Goto, value: 62});
		self.action.insert((36, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 15});
		self.action.insert((36, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 17});
		self.action.insert((36, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 18});
		self.action.insert((36, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 14});
		self.action.insert((36, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 16});
		self.action.insert((37, TokenType::Modulo), ActionNode{action: ParserAction::Reduce, value: 36});
		self.action.insert((37, TokenType::Divide), ActionNode{action: ParserAction::Reduce, value: 36});
		self.action.insert((37, TokenType::Multiply), ActionNode{action: ParserAction::Reduce, value: 36});
		self.action.insert((37, TokenType::Subtract), ActionNode{action: ParserAction::Reduce, value: 36});
		self.action.insert((37, TokenType::Add), ActionNode{action: ParserAction::Reduce, value: 36});
		self.action.insert((37, TokenType::At), ActionNode{action: ParserAction::Reduce, value: 36});
		self.action.insert((37, TokenType::While), ActionNode{action: ParserAction::Reduce, value: 36});
		self.action.insert((37, TokenType::For), ActionNode{action: ParserAction::Reduce, value: 36});
		self.action.insert((37, TokenType::If), ActionNode{action: ParserAction::Reduce, value: 36});
		self.action.insert((37, TokenType::Identifier), ActionNode{action: ParserAction::Reduce, value: 36});
		self.action.insert((37, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Reduce, value: 36});
		self.action.insert((37, TokenType::Term), ActionNode{action: ParserAction::Reduce, value: 36});
		self.action.insert((37, TokenType::Newline), ActionNode{action: ParserAction::Reduce, value: 36});
		self.action.insert((38, TokenType::Subtract), ActionNode{action: ParserAction::Reduce, value: 29});
		self.action.insert((38, TokenType::Add), ActionNode{action: ParserAction::Reduce, value: 29});
		self.action.insert((38, TokenType::At), ActionNode{action: ParserAction::Reduce, value: 29});
		self.action.insert((38, TokenType::While), ActionNode{action: ParserAction::Reduce, value: 29});
		self.action.insert((38, TokenType::For), ActionNode{action: ParserAction::Reduce, value: 29});
		self.action.insert((38, TokenType::If), ActionNode{action: ParserAction::Reduce, value: 29});
		self.action.insert((38, TokenType::Identifier), ActionNode{action: ParserAction::Reduce, value: 29});
		self.action.insert((38, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Reduce, value: 29});
		self.action.insert((38, TokenType::Term), ActionNode{action: ParserAction::Reduce, value: 29});
		self.action.insert((38, TokenType::Newline), ActionNode{action: ParserAction::Reduce, value: 29});
		self.action.insert((39, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 63});
		self.action.insert((39, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 64});
		self.action.insert((39, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 18});
		self.action.insert((39, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 14});
		self.action.insert((39, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 16});
		self.action.insert((40, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 65});
		self.action.insert((40, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 64});
		self.action.insert((40, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 18});
		self.action.insert((40, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 14});
		self.action.insert((40, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 16});
		self.action.insert((41, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 66});
		self.action.insert((41, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 64});
		self.action.insert((41, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 18});
		self.action.insert((41, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 14});
		self.action.insert((41, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 16});
		...
		self.action.insert((51, TokenType::Modulo), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((51, TokenType::Divide), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((51, TokenType::Multiply), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((51, TokenType::Subtract), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((51, TokenType::Add), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((51, TokenType::At), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((51, TokenType::While), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((51, TokenType::For), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((51, TokenType::If), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((51, TokenType::Identifier), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((51, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((51, TokenType::Term), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((51, TokenType::Newline), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((52, TokenType::RightParenthesis), ActionNode{action: ParserAction::Shift, value: 85});
		self.action.insert((53, TokenType::RightParenthesis), ActionNode{action: ParserAction::Reduce, value: 25});
		self.action.insert((54, TokenType::StatementExpression), ActionNode{action: ParserAction::Goto, value: 86});
		self.action.insert((54, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 30});
		self.action.insert((54, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 32});
		self.action.insert((54, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 33});
		self.action.insert((54, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 29});
		self.action.insert((54, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 31});
		self.action.insert((55, TokenType::StatementExpression), ActionNode{action: ParserAction::Goto, value: 87});
		self.action.insert((55, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 30});
		self.action.insert((55, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 32});
		self.action.insert((55, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 33});
		self.action.insert((55, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 29});
		self.action.insert((55, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 31});
		self.action.insert((56, TokenType::Modulo), ActionNode{action: ParserAction::Reduce, value: 36});
		self.action.insert((56, TokenType::Divide), ActionNode{action: ParserAction::Reduce, value: 36});
		self.action.insert((56, TokenType::Multiply), ActionNode{action: ParserAction::Reduce, value: 36});
		self.action.insert((56, TokenType::Subtract), ActionNode{action: ParserAction::Reduce, value: 36});
		self.action.insert((56, TokenType::Add), ActionNode{action: ParserAction::Reduce, value: 36});
		self.action.insert((56, TokenType::RightParenthesis), ActionNode{action: ParserAction::Reduce, value: 36});
		self.action.insert((57, TokenType::Subtract), ActionNode{action: ParserAction::Reduce, value: 29});
		self.action.insert((57, TokenType::Add), ActionNode{action: ParserAction::Reduce, value: 29});
		self.action.insert((57, TokenType::RightParenthesis), ActionNode{action: ParserAction::Reduce, value: 29});
		self.action.insert((58, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 88});
		self.action.insert((58, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 89});
		self.action.insert((58, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 33});
		self.action.insert((58, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 29});
		self.action.insert((58, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 31});
		self.action.insert((59, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 90});
		self.action.insert((59, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 89});
		self.action.insert((59, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 33});
		self.action.insert((59, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 29});
		self.action.insert((59, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 31});
		self.action.insert((60, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 91});
		self.action.insert((60, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 89});
		self.action.insert((60, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 33});
		self.action.insert((60, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 29});
		self.action.insert((60, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 31});
		self.action.insert((61, TokenType::At), ActionNode{action: ParserAction::Reduce, value: 27});
		self.action.insert((61, TokenType::While), ActionNode{action: ParserAction::Reduce, value: 27});
		self.action.insert((61, TokenType::For), ActionNode{action: ParserAction::Reduce, value: 27});
		self.action.insert((61, TokenType::If), ActionNode{action: ParserAction::Reduce, value: 27});
		self.action.insert((61, TokenType::Identifier), ActionNode{action: ParserAction::Reduce, value: 27});
		self.action.insert((61, TokenType::Subtract), ActionNode{action: ParserAction::Reduce, value: 27});
		self.action.insert((61, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Reduce, value: 27});
		self.action.insert((61, TokenType::Term), ActionNode{action: ParserAction::Reduce, value: 27});
		self.action.insert((61, TokenType::Newline), ActionNode{action: ParserAction::Reduce, value: 27});
		self.action.insert((62, TokenType::At), ActionNode{action: ParserAction::Reduce, value: 28});
		self.action.insert((62, TokenType::While), ActionNode{action: ParserAction::Reduce, value: 28});
		self.action.insert((62, TokenType::For), ActionNode{action: ParserAction::Reduce, value: 28});
		self.action.insert((62, TokenType::If), ActionNode{action: ParserAction::Reduce, value: 28});
		self.action.insert((62, TokenType::Identifier), ActionNode{action: ParserAction::Reduce, value: 28});
		self.action.insert((62, TokenType::Subtract), ActionNode{action: ParserAction::Reduce, value: 28});
		self.action.insert((62, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Reduce, value: 28});
		self.action.insert((62, TokenType::Term), ActionNode{action: ParserAction::Reduce, value: 28});
		self.action.insert((62, TokenType::Newline), ActionNode{action: ParserAction::Reduce, value: 28});
		self.action.insert((63, TokenType::Subtract), ActionNode{action: ParserAction::Reduce, value: 31});
		self.action.insert((63, TokenType::Add), ActionNode{action: ParserAction::Reduce, value: 31});
		self.action.insert((63, TokenType::At), ActionNode{action: ParserAction::Reduce, value: 31});
		self.action.insert((63, TokenType::While), ActionNode{action: ParserAction::Reduce, value: 31});
		self.action.insert((63, TokenType::For), ActionNode{action: ParserAction::Reduce, value: 31});
		self.action.insert((63, TokenType::If), ActionNode{action: ParserAction::Reduce, value: 31});
		self.action.insert((63, TokenType::Identifier), ActionNode{action: ParserAction::Reduce, value: 31});
		self.action.insert((63, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Reduce, value: 31});
		self.action.insert((63, TokenType::Term), ActionNode{action: ParserAction::Reduce, value: 31});
		self.action.insert((63, TokenType::Newline), ActionNode{action: ParserAction::Reduce, value: 31});
		self.action.insert((64, TokenType::StatementExpression2p), ActionNode{action: ParserAction::Goto, value: 38});
		...
		self.action.insert((64, TokenType::At), ActionNode{action: ParserAction::Reduce, value: 30});
		self.action.insert((64, TokenType::While), ActionNode{action: ParserAction::Reduce, value: 30});
		self.action.insert((64, TokenType::For), ActionNode{action: ParserAction::Reduce, value: 30});
		self.action.insert((64, TokenType::If), ActionNode{action: ParserAction::Reduce, value: 30});
		self.action.insert((64, TokenType::Identifier), ActionNode{action: ParserAction::Reduce, value: 30});
		self.action.insert((64, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Reduce, value: 30});
		self.action.insert((64, TokenType::Term), ActionNode{action: ParserAction::Reduce, value: 30});
		self.action.insert((64, TokenType::Newline), ActionNode{action: ParserAction::Reduce, value: 30});
		self.action.insert((64, TokenType::Multiply), ActionNode{action: ParserAction::Shift, value: 39});
		self.action.insert((64, TokenType::Divide), ActionNode{action: ParserAction::Shift, value: 40});
		self.action.insert((64, TokenType::Modulo), ActionNode{action: ParserAction::Shift, value: 41});
		self.action.insert((65, TokenType::Subtract), ActionNode{action: ParserAction::Reduce, value: 32});
		self.action.insert((65, TokenType::Add), ActionNode{action: ParserAction::Reduce, value: 32});
		self.action.insert((65, TokenType::At), ActionNode{action: ParserAction::Reduce, value: 32});
		self.action.insert((65, TokenType::While), ActionNode{action: ParserAction::Reduce, value: 32});
		self.action.insert((65, TokenType::For), ActionNode{action: ParserAction::Reduce, value: 32});
		self.action.insert((65, TokenType::If), ActionNode{action: ParserAction::Reduce, value: 32});
		self.action.insert((65, TokenType::Identifier), ActionNode{action: ParserAction::Reduce, value: 32});
		self.action.insert((65, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Reduce, value: 32});
		self.action.insert((65, TokenType::Term), ActionNode{action: ParserAction::Reduce, value: 32});
		self.action.insert((65, TokenType::Newline), ActionNode{action: ParserAction::Reduce, value: 32});
		self.action.insert((66, TokenType::Subtract), ActionNode{action: ParserAction::Reduce, value: 33});
		self.action.insert((66, TokenType::Add), ActionNode{action: ParserAction::Reduce, value: 33});
		self.action.insert((66, TokenType::At), ActionNode{action: ParserAction::Reduce, value: 33});
		self.action.insert((66, TokenType::While), ActionNode{action: ParserAction::Reduce, value: 33});
		self.action.insert((66, TokenType::For), ActionNode{action: ParserAction::Reduce, value: 33});
		self.action.insert((66, TokenType::If), ActionNode{action: ParserAction::Reduce, value: 33});
		self.action.insert((66, TokenType::Identifier), ActionNode{action: ParserAction::Reduce, value: 33});
		self.action.insert((66, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Reduce, value: 33});
		self.action.insert((66, TokenType::Term), ActionNode{action: ParserAction::Reduce, value: 33});
		self.action.insert((66, TokenType::Newline), ActionNode{action: ParserAction::Reduce, value: 33});
		...
		self.action.insert((74, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 104});
		...
		self.action.insert((74, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 106});
		...
		self.action.insert((74, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 107});
		self.action.insert((74, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 103});
		self.action.insert((74, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 105});
		...
		self.action.insert((77, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 104});
		...
		self.action.insert((77, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 106});
		...
		self.action.insert((77, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 107});
		self.action.insert((77, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 103});
		self.action.insert((77, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 105});
		self.action.insert((78, TokenType::RightParenthesis), ActionNode{action: ParserAction::Reduce, value: 23});
		self.action.insert((78, TokenType::Comma), ActionNode{action: ParserAction::Reduce, value: 23});
		self.action.insert((79, TokenType::RightParenthesis), ActionNode{action: ParserAction::Shift, value: 115});
		...
		self.action.insert((85, TokenType::Modulo), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((85, TokenType::Divide), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((85, TokenType::Multiply), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((85, TokenType::Subtract), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((85, TokenType::Add), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((85, TokenType::RightParenthesis), ActionNode{action: ParserAction::Reduce, value: 35});
		...
		self.action.insert((89, TokenType::StatementExpression2p), ActionNode{action: ParserAction::Goto, value: 57});
		...
		self.action.insert((89, TokenType::Multiply), ActionNode{action: ParserAction::Shift, value: 58});
		self.action.insert((89, TokenType::Divide), ActionNode{action: ParserAction::Shift, value: 59});
		self.action.insert((89, TokenType::Modulo), ActionNode{action: ParserAction::Shift, value: 60});
		...
		self.action.insert((95, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 104});
		...
		self.action.insert((95, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 106});
		...
		self.action.insert((95, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 107});
		self.action.insert((95, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 103});
		self.action.insert((95, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 105});
		...
		self.action.insert((103, TokenType::StatementExpression), ActionNode{action: ParserAction::Goto, value: 125});
		self.action.insert((103, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 30});
		self.action.insert((103, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 32});
		self.action.insert((103, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 33});
		self.action.insert((103, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 29});
		self.action.insert((103, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 31});
		...
		self.action.insert((105, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 103});
		...
		self.action.insert((115, TokenType::LeftCurlyBrace), ActionNode{action: ParserAction::Shift, value: 140});
		...
		self.action.insert((120, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 142});
		...
		self.action.insert((124, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 104});
		self.action.insert((124, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 106});
		self.action.insert((124, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 107});
		self.action.insert((124, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 103});
		self.action.insert((124, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 105});
		self.action.insert((125, TokenType::RightParenthesis), ActionNode{action: ParserAction::Shift, value: 148});
		...
		self.action.insert((127, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 103});
		...
		self.action.insert((128, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 103});
		...
		self.action.insert((131, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 103});
		...
		self.action.insert((132, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 103});
		...
		self.action.insert((133, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 103});
		...
		self.action.insert((137, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 104});
		...
		self.action.insert((137, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 106});
		...
		self.action.insert((137, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 107});
		self.action.insert((137, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 103});
		self.action.insert((137, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 105});
		...
		self.action.insert((140, TokenType::StatementSuiteFunction), ActionNode{action: ParserAction::Goto, value: 160});
		self.action.insert((140, TokenType::StatementListFunction), ActionNode{action: ParserAction::Goto, value: 94});
		self.action.insert((140, TokenType::StatementLimited), ActionNode{action: ParserAction::Goto, value: 95});
		self.action.insert((140, TokenType::StatementSimple), ActionNode{action: ParserAction::Goto, value: 96});
		self.action.insert((140, TokenType::StatementComplex), ActionNode{action: ParserAction::Goto, value: 97});
		self.action.insert((140, TokenType::StatementExpression), ActionNode{action: ParserAction::Goto, value: 98});
		self.action.insert((140, TokenType::StatementAssignment), ActionNode{action: ParserAction::Goto, value: 99});
		self.action.insert((140, TokenType::StatementConditional), ActionNode{action: ParserAction::Goto, value: 100});
		self.action.insert((140, TokenType::StatementLoop), ActionNode{action: ParserAction::Goto, value: 101});
		self.action.insert((140, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 104});
		self.action.insert((140, TokenType::Identifier), ActionNode{action: ParserAction::Shift, value: 102});
		self.action.insert((140, TokenType::If), ActionNode{action: ParserAction::Shift, value: 108});
		self.action.insert((140, TokenType::StatementLoopFor), ActionNode{action: ParserAction::Goto, value: 109});
		self.action.insert((140, TokenType::StatementLoopWhile), ActionNode{action: ParserAction::Goto, value: 110});
		self.action.insert((140, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 106});
		self.action.insert((140, TokenType::For), ActionNode{action: ParserAction::Shift, value: 111});
		self.action.insert((140, TokenType::While), ActionNode{action: ParserAction::Shift, value: 112});
		self.action.insert((140, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 107});
		self.action.insert((140, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 103});
		self.action.insert((140, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 105});
		self.action.insert((141, TokenType::RightParenthesis), ActionNode{action: ParserAction::Reduce, value: 22});
		...
		self.action.insert((148, TokenType::Modulo), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((148, TokenType::Divide), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((148, TokenType::Multiply), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((148, TokenType::Subtract), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((148, TokenType::Add), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((148, TokenType::While), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((148, TokenType::For), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((148, TokenType::If), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((148, TokenType::Identifier), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((148, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((148, TokenType::Term), ActionNode{action: ParserAction::Reduce, value: 35});
		self.action.insert((148, TokenType::Newline), ActionNode{action: ParserAction::Reduce, value: 35});
		...
		self.action.insert((155, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 104});
		...
		self.action.insert((155, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 106});
		...
		self.action.insert((155, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 107});
		self.action.insert((155, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 103});
		self.action.insert((155, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 105});
		...
		self.action.insert((157, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 104});
		...
		self.action.insert((157, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 106});
		...
		self.action.insert((157, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 107});
		self.action.insert((157, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 103});
		self.action.insert((157, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 105});
		...
		self.action.insert((160, TokenType::RightCurlyBrace), ActionNode{action: ParserAction::Shift, value: 170});
		self.action.insert((161, TokenType::RightParenthesis), ActionNode{action: ParserAction::Shift, value: 171});
		self.action.insert((161, TokenType::Comma), ActionNode{action: ParserAction::Shift, value: 116});
		self.action.insert((162, TokenType::ConditionalExpression), ActionNode{action: ParserAction::Goto, value: 172});
		...
		self.action.insert((163, TokenType::LeftCurlyBrace), ActionNode{action: ParserAction::Shift, value: 173});
		self.action.insert((164, TokenType::StatementSuiteFunction), ActionNode{action: ParserAction::Goto, value: 174});
		...
		self.action.insert((164, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 104});
		...
		self.action.insert((164, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 106});
		...
		self.action.insert((164, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 107});
		self.action.insert((164, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 103});
		self.action.insert((164, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 105});
		self.action.insert((165, TokenType::RightCurlyBrace), ActionNode{action: ParserAction::Shift, value: 175});
		self.action.insert((166, TokenType::LeftCurlyBrace), ActionNode{action: ParserAction::Shift, value: 176});
		self.action.insert((166, TokenType::Ellipsis), ActionNode{action: ParserAction::Shift, value: 177});
		self.action.insert((167, TokenType::RightCurlyBrace), ActionNode{action: ParserAction::Shift, value: 178});
		...
		self.action.insert((169, TokenType::StatementSuiteFunction), ActionNode{action: ParserAction::Goto, value: 179});
		...
		self.action.insert((169, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 104});
		...
		self.action.insert((169, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 106});
		...
		self.action.insert((169, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 107});
		self.action.insert((169, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 103});
		self.action.insert((169, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 105});
		self.action.insert((170, TokenType::At), ActionNode{action: ParserAction::Reduce, value: 21});
		self.action.insert((170, TokenType::While), ActionNode{action: ParserAction::Reduce, value: 21});
		self.action.insert((170, TokenType::For), ActionNode{action: ParserAction::Reduce, value: 21});
		self.action.insert((170, TokenType::If), ActionNode{action: ParserAction::Reduce, value: 21});
		self.action.insert((170, TokenType::Identifier), ActionNode{action: ParserAction::Reduce, value: 21});
		self.action.insert((170, TokenType::Subtract), ActionNode{action: ParserAction::Reduce, value: 21});
		self.action.insert((170, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Reduce, value: 21});
		self.action.insert((170, TokenType::Term), ActionNode{action: ParserAction::Reduce, value: 21});
		self.action.insert((170, TokenType::Newline), ActionNode{action: ParserAction::Reduce, value: 21});
		...
		self.action.insert((173, TokenType::StatementListFunction), ActionNode{action: ParserAction::Goto, value: 94});
		self.action.insert((173, TokenType::StatementLimited), ActionNode{action: ParserAction::Goto, value: 95});
		self.action.insert((173, TokenType::StatementSimple), ActionNode{action: ParserAction::Goto, value: 96});
		self.action.insert((173, TokenType::StatementComplex), ActionNode{action: ParserAction::Goto, value: 97});
		self.action.insert((173, TokenType::StatementExpression), ActionNode{action: ParserAction::Goto, value: 98});
		self.action.insert((173, TokenType::StatementAssignment), ActionNode{action: ParserAction::Goto, value: 99});
		self.action.insert((173, TokenType::StatementConditional), ActionNode{action: ParserAction::Goto, value: 100});
		self.action.insert((173, TokenType::StatementLoop), ActionNode{action: ParserAction::Goto, value: 101});
		self.action.insert((173, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 104});
		self.action.insert((173, TokenType::Identifier), ActionNode{action: ParserAction::Shift, value: 102});
		self.action.insert((173, TokenType::If), ActionNode{action: ParserAction::Shift, value: 108});
		self.action.insert((173, TokenType::StatementLoopFor), ActionNode{action: ParserAction::Goto, value: 109});
		self.action.insert((173, TokenType::StatementLoopWhile), ActionNode{action: ParserAction::Goto, value: 110});
		self.action.insert((173, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 106});
		self.action.insert((173, TokenType::For), ActionNode{action: ParserAction::Shift, value: 111});
		self.action.insert((173, TokenType::While), ActionNode{action: ParserAction::Shift, value: 112});
		self.action.insert((173, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 107});
		self.action.insert((173, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 103});
		...
		self.action.insert((176, TokenType::StatementListFunction), ActionNode{action: ParserAction::Goto, value: 94});
		self.action.insert((176, TokenType::StatementLimited), ActionNode{action: ParserAction::Goto, value: 95});
		self.action.insert((176, TokenType::StatementSimple), ActionNode{action: ParserAction::Goto, value: 96});
		self.action.insert((176, TokenType::StatementComplex), ActionNode{action: ParserAction::Goto, value: 97});
		self.action.insert((176, TokenType::StatementExpression), ActionNode{action: ParserAction::Goto, value: 98});
		self.action.insert((176, TokenType::StatementAssignment), ActionNode{action: ParserAction::Goto, value: 99});
		self.action.insert((176, TokenType::StatementConditional), ActionNode{action: ParserAction::Goto, value: 100});
		self.action.insert((176, TokenType::StatementLoop), ActionNode{action: ParserAction::Goto, value: 101});
		self.action.insert((176, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 104});
		self.action.insert((176, TokenType::Identifier), ActionNode{action: ParserAction::Shift, value: 102});
		self.action.insert((176, TokenType::If), ActionNode{action: ParserAction::Shift, value: 108});
		self.action.insert((176, TokenType::StatementLoopFor), ActionNode{action: ParserAction::Goto, value: 109});
		self.action.insert((176, TokenType::StatementLoopWhile), ActionNode{action: ParserAction::Goto, value: 110});
		self.action.insert((176, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 106});
		self.action.insert((176, TokenType::For), ActionNode{action: ParserAction::Shift, value: 111});
		self.action.insert((176, TokenType::While), ActionNode{action: ParserAction::Shift, value: 112});
		self.action.insert((176, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 107});
		self.action.insert((176, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 103});
		...
		self.action.insert((180, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 104});
		...
		self.action.insert((180, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 106});
		...
		self.action.insert((180, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 107});
		self.action.insert((180, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 103});
		self.action.insert((180, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 105});
		self.action.insert((181, TokenType::StatementSuiteFunction), ActionNode{action: ParserAction::Goto, value: 192});
		self.action.insert((181, TokenType::StatementListFunction), ActionNode{action: ParserAction::Goto, value: 94});
		self.action.insert((181, TokenType::StatementLimited), ActionNode{action: ParserAction::Goto, value: 95});
		self.action.insert((181, TokenType::StatementSimple), ActionNode{action: ParserAction::Goto, value: 96});
		self.action.insert((181, TokenType::StatementComplex), ActionNode{action: ParserAction::Goto, value: 97});
		self.action.insert((181, TokenType::StatementExpression), ActionNode{action: ParserAction::Goto, value: 98});
		self.action.insert((181, TokenType::StatementAssignment), ActionNode{action: ParserAction::Goto, value: 99});
		self.action.insert((181, TokenType::StatementConditional), ActionNode{action: ParserAction::Goto, value: 100});
		self.action.insert((181, TokenType::StatementLoop), ActionNode{action: ParserAction::Goto, value: 101});
		self.action.insert((181, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 104});
		self.action.insert((181, TokenType::Identifier), ActionNode{action: ParserAction::Shift, value: 102});
		self.action.insert((181, TokenType::If), ActionNode{action: ParserAction::Shift, value: 108});
		self.action.insert((181, TokenType::StatementLoopFor), ActionNode{action: ParserAction::Goto, value: 109});
		self.action.insert((181, TokenType::StatementLoopWhile), ActionNode{action: ParserAction::Goto, value: 110});
		self.action.insert((181, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 106});
		self.action.insert((181, TokenType::For), ActionNode{action: ParserAction::Shift, value: 111});
		self.action.insert((181, TokenType::While), ActionNode{action: ParserAction::Shift, value: 112});
		self.action.insert((181, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 107});
		self.action.insert((181, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 103});
		...
		self.action.insert((183, TokenType::At), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((183, TokenType::While), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((183, TokenType::For), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((183, TokenType::If), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((183, TokenType::Identifier), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((183, TokenType::Subtract), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((183, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((183, TokenType::Term), ActionNode{action: ParserAction::Reduce, value: 43});
		...
		self.action.insert((190, TokenType::At), ActionNode{action: ParserAction::Reduce, value: 56});
		self.action.insert((190, TokenType::While), ActionNode{action: ParserAction::Reduce, value: 56});
		self.action.insert((190, TokenType::For), ActionNode{action: ParserAction::Reduce, value: 56});
		self.action.insert((190, TokenType::If), ActionNode{action: ParserAction::Reduce, value: 56});
		self.action.insert((190, TokenType::Identifier), ActionNode{action: ParserAction::Reduce, value: 56});
		self.action.insert((190, TokenType::Subtract), ActionNode{action: ParserAction::Reduce, value: 56});
		self.action.insert((190, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Reduce, value: 56});
		self.action.insert((190, TokenType::Term), ActionNode{action: ParserAction::Reduce, value: 56});
		self.action.insert((190, TokenType::Newline), ActionNode{action: ParserAction::Reduce, value: 56});
		self.action.insert((191, TokenType::RightCurlyBrace), ActionNode{action: ParserAction::Shift, value: 199});
		self.action.insert((192, TokenType::RightCurlyBrace), ActionNode{action: ParserAction::Shift, value: 200});
		self.action.insert((193, TokenType::StatementConditional3), ActionNode{action: ParserAction::Goto, value: 201});
		self.action.insert((193, TokenType::Else), ActionNode{action: ParserAction::Shift, value: 202});
		self.action.insert((194, TokenType::ConditionalExpression), ActionNode{action: ParserAction::Goto, value: 203});
		...
		self.action.insert((195, TokenType::LeftCurlyBrace), ActionNode{action: ParserAction::Shift, value: 204});
		self.action.insert((196, TokenType::StatementSuiteFunction), ActionNode{action: ParserAction::Goto, value: 205});
		self.action.insert((196, TokenType::StatementListFunction), ActionNode{action: ParserAction::Goto, value: 94});
		self.action.insert((196, TokenType::StatementLimited), ActionNode{action: ParserAction::Goto, value: 95});
		self.action.insert((196, TokenType::StatementSimple), ActionNode{action: ParserAction::Goto, value: 96});
		self.action.insert((196, TokenType::StatementComplex), ActionNode{action: ParserAction::Goto, value: 97});
		self.action.insert((196, TokenType::StatementExpression), ActionNode{action: ParserAction::Goto, value: 98});
		self.action.insert((196, TokenType::StatementAssignment), ActionNode{action: ParserAction::Goto, value: 99});
		self.action.insert((196, TokenType::StatementConditional), ActionNode{action: ParserAction::Goto, value: 100});
		self.action.insert((196, TokenType::StatementLoop), ActionNode{action: ParserAction::Goto, value: 101});
		self.action.insert((196, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 104});
		self.action.insert((196, TokenType::Identifier), ActionNode{action: ParserAction::Shift, value: 102});
		self.action.insert((196, TokenType::If), ActionNode{action: ParserAction::Shift, value: 108});
		self.action.insert((196, TokenType::StatementLoopFor), ActionNode{action: ParserAction::Goto, value: 109});
		self.action.insert((196, TokenType::StatementLoopWhile), ActionNode{action: ParserAction::Goto, value: 110});
		self.action.insert((196, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 106});
		self.action.insert((196, TokenType::For), ActionNode{action: ParserAction::Shift, value: 111});
		self.action.insert((196, TokenType::While), ActionNode{action: ParserAction::Shift, value: 112});
		self.action.insert((196, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 107});
		self.action.insert((196, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 103});
		...
		self.action.insert((198, TokenType::StatementSuiteFunction), ActionNode{action: ParserAction::Goto, value: 206});
		self.action.insert((198, TokenType::StatementListFunction), ActionNode{action: ParserAction::Goto, value: 94});
		self.action.insert((198, TokenType::StatementLimited), ActionNode{action: ParserAction::Goto, value: 95});
		self.action.insert((198, TokenType::StatementSimple), ActionNode{action: ParserAction::Goto, value: 96});
		self.action.insert((198, TokenType::StatementComplex), ActionNode{action: ParserAction::Goto, value: 97});
		self.action.insert((198, TokenType::StatementExpression), ActionNode{action: ParserAction::Goto, value: 98});
		self.action.insert((198, TokenType::StatementAssignment), ActionNode{action: ParserAction::Goto, value: 99});
		self.action.insert((198, TokenType::StatementConditional), ActionNode{action: ParserAction::Goto, value: 100});
		self.action.insert((198, TokenType::StatementLoop), ActionNode{action: ParserAction::Goto, value: 101});
		self.action.insert((198, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 104});
		self.action.insert((198, TokenType::Identifier), ActionNode{action: ParserAction::Shift, value: 102});
		self.action.insert((198, TokenType::If), ActionNode{action: ParserAction::Shift, value: 108});
		self.action.insert((198, TokenType::StatementLoopFor), ActionNode{action: ParserAction::Goto, value: 109});
		self.action.insert((198, TokenType::StatementLoopWhile), ActionNode{action: ParserAction::Goto, value: 110});
		self.action.insert((198, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 106});
		self.action.insert((198, TokenType::For), ActionNode{action: ParserAction::Shift, value: 111});
		self.action.insert((198, TokenType::While), ActionNode{action: ParserAction::Shift, value: 112});
		self.action.insert((198, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 107});
		self.action.insert((198, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 103});
		self.action.insert((198, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 105});
		self.action.insert((199, TokenType::At), ActionNode{action: ParserAction::Reduce, value: 21});
		self.action.insert((199, TokenType::Newline), ActionNode{action: ParserAction::Reduce, value: 21});
		self.action.insert((200, TokenType::At), ActionNode{action: ParserAction::Reduce, value: 41});
		self.action.insert((200, TokenType::While), ActionNode{action: ParserAction::Reduce, value: 41});
		self.action.insert((200, TokenType::For), ActionNode{action: ParserAction::Reduce, value: 41});
		self.action.insert((200, TokenType::If), ActionNode{action: ParserAction::Reduce, value: 41});
		self.action.insert((200, TokenType::Identifier), ActionNode{action: ParserAction::Reduce, value: 41});
		self.action.insert((200, TokenType::Subtract), ActionNode{action: ParserAction::Reduce, value: 41});
		self.action.insert((200, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Reduce, value: 41});
		self.action.insert((200, TokenType::Term), ActionNode{action: ParserAction::Reduce, value: 41});
		self.action.insert((200, TokenType::Newline), ActionNode{action: ParserAction::Reduce, value: 41});
		self.action.insert((200, TokenType::Elif), ActionNode{action: ParserAction::Reduce, value: 41});
		self.action.insert((201, TokenType::At), ActionNode{action: ParserAction::Reduce, value: 42});
		self.action.insert((201, TokenType::While), ActionNode{action: ParserAction::Reduce, value: 42});
		self.action.insert((201, TokenType::For), ActionNode{action: ParserAction::Reduce, value: 42});
		self.action.insert((201, TokenType::If), ActionNode{action: ParserAction::Reduce, value: 42});
		self.action.insert((201, TokenType::Identifier), ActionNode{action: ParserAction::Reduce, value: 42});
		self.action.insert((201, TokenType::Subtract), ActionNode{action: ParserAction::Reduce, value: 42});
		self.action.insert((201, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Reduce, value: 42});
		self.action.insert((201, TokenType::Term), ActionNode{action: ParserAction::Reduce, value: 42});
		self.action.insert((201, TokenType::Newline), ActionNode{action: ParserAction::Reduce, value: 42});
		self.action.insert((201, TokenType::Elif), ActionNode{action: ParserAction::Reduce, value: 42});
		self.action.insert((202, TokenType::LeftCurlyBrace), ActionNode{action: ParserAction::Shift, value: 207});
		self.action.insert((203, TokenType::LeftCurlyBrace), ActionNode{action: ParserAction::Shift, value: 208});
		self.action.insert((204, TokenType::StatementSuiteFunction), ActionNode{action: ParserAction::Goto, value: 209});
		self.action.insert((204, TokenType::StatementListFunction), ActionNode{action: ParserAction::Goto, value: 94});
		self.action.insert((204, TokenType::StatementLimited), ActionNode{action: ParserAction::Goto, value: 95});
		self.action.insert((204, TokenType::StatementSimple), ActionNode{action: ParserAction::Goto, value: 96});
		self.action.insert((204, TokenType::StatementComplex), ActionNode{action: ParserAction::Goto, value: 97});
		self.action.insert((204, TokenType::StatementExpression), ActionNode{action: ParserAction::Goto, value: 98});
		self.action.insert((204, TokenType::StatementAssignment), ActionNode{action: ParserAction::Goto, value: 99});
		self.action.insert((204, TokenType::StatementConditional), ActionNode{action: ParserAction::Goto, value: 100});
		self.action.insert((204, TokenType::StatementLoop), ActionNode{action: ParserAction::Goto, value: 101});
		self.action.insert((204, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 104});
		self.action.insert((204, TokenType::Identifier), ActionNode{action: ParserAction::Shift, value: 102});
		self.action.insert((204, TokenType::If), ActionNode{action: ParserAction::Shift, value: 108});
		self.action.insert((204, TokenType::StatementLoopFor), ActionNode{action: ParserAction::Goto, value: 109});
		self.action.insert((204, TokenType::StatementLoopWhile), ActionNode{action: ParserAction::Goto, value: 110});
		self.action.insert((204, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 106});
		self.action.insert((204, TokenType::For), ActionNode{action: ParserAction::Shift, value: 111});
		self.action.insert((204, TokenType::While), ActionNode{action: ParserAction::Shift, value: 112});
		self.action.insert((204, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 107});
		self.action.insert((204, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 103});
		self.action.insert((204, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 105});
		self.action.insert((205, TokenType::RightCurlyBrace), ActionNode{action: ParserAction::Shift, value: 210});
		self.action.insert((206, TokenType::RightCurlyBrace), ActionNode{action: ParserAction::Shift, value: 211});
		self.action.insert((207, TokenType::StatementSuiteFunction), ActionNode{action: ParserAction::Goto, value: 212});
		self.action.insert((207, TokenType::StatementListFunction), ActionNode{action: ParserAction::Goto, value: 94});
		self.action.insert((207, TokenType::StatementLimited), ActionNode{action: ParserAction::Goto, value: 95});
		self.action.insert((207, TokenType::StatementSimple), ActionNode{action: ParserAction::Goto, value: 96});
		self.action.insert((207, TokenType::StatementComplex), ActionNode{action: ParserAction::Goto, value: 97});
		self.action.insert((207, TokenType::StatementExpression), ActionNode{action: ParserAction::Goto, value: 98});
		self.action.insert((207, TokenType::StatementAssignment), ActionNode{action: ParserAction::Goto, value: 99});
		self.action.insert((207, TokenType::StatementConditional), ActionNode{action: ParserAction::Goto, value: 100});
		self.action.insert((207, TokenType::StatementLoop), ActionNode{action: ParserAction::Goto, value: 101});
		self.action.insert((207, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 104});
		self.action.insert((207, TokenType::Identifier), ActionNode{action: ParserAction::Shift, value: 102});
		self.action.insert((207, TokenType::If), ActionNode{action: ParserAction::Shift, value: 108});
		self.action.insert((207, TokenType::StatementLoopFor), ActionNode{action: ParserAction::Goto, value: 109});
		self.action.insert((207, TokenType::StatementLoopWhile), ActionNode{action: ParserAction::Goto, value: 110});
		self.action.insert((207, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 106});
		self.action.insert((207, TokenType::For), ActionNode{action: ParserAction::Shift, value: 111});
		self.action.insert((207, TokenType::While), ActionNode{action: ParserAction::Shift, value: 112});
		self.action.insert((207, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 107});
		self.action.insert((207, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 103});
		self.action.insert((207, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 105});
		self.action.insert((208, TokenType::StatementSuiteFunction), ActionNode{action: ParserAction::Goto, value: 213});
		self.action.insert((208, TokenType::StatementListFunction), ActionNode{action: ParserAction::Goto, value: 94});
		self.action.insert((208, TokenType::StatementLimited), ActionNode{action: ParserAction::Goto, value: 95});
		self.action.insert((208, TokenType::StatementSimple), ActionNode{action: ParserAction::Goto, value: 96});
		self.action.insert((208, TokenType::StatementComplex), ActionNode{action: ParserAction::Goto, value: 97});
		self.action.insert((208, TokenType::StatementExpression), ActionNode{action: ParserAction::Goto, value: 98});
		self.action.insert((208, TokenType::StatementAssignment), ActionNode{action: ParserAction::Goto, value: 99});
		self.action.insert((208, TokenType::StatementConditional), ActionNode{action: ParserAction::Goto, value: 100});
		self.action.insert((208, TokenType::StatementLoop), ActionNode{action: ParserAction::Goto, value: 101});
		self.action.insert((208, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 104});
		self.action.insert((208, TokenType::Identifier), ActionNode{action: ParserAction::Shift, value: 102});
		self.action.insert((208, TokenType::If), ActionNode{action: ParserAction::Shift, value: 108});
		self.action.insert((208, TokenType::StatementLoopFor), ActionNode{action: ParserAction::Goto, value: 109});
		self.action.insert((208, TokenType::StatementLoopWhile), ActionNode{action: ParserAction::Goto, value: 110});
		self.action.insert((208, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 106});
		self.action.insert((208, TokenType::For), ActionNode{action: ParserAction::Shift, value: 111});
		self.action.insert((208, TokenType::While), ActionNode{action: ParserAction::Shift, value: 112});
		self.action.insert((208, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 107});
		self.action.insert((208, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 103});
		self.action.insert((208, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 105});
		self.action.insert((209, TokenType::RightCurlyBrace), ActionNode{action: ParserAction::Shift, value: 214});
		self.action.insert((210, TokenType::While), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((210, TokenType::For), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((210, TokenType::If), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((210, TokenType::Identifier), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((210, TokenType::Subtract), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((210, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((210, TokenType::Term), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((210, TokenType::Newline), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((211, TokenType::While), ActionNode{action: ParserAction::Reduce, value: 56});
		self.action.insert((211, TokenType::For), ActionNode{action: ParserAction::Reduce, value: 56});
		self.action.insert((211, TokenType::If), ActionNode{action: ParserAction::Reduce, value: 56});
		self.action.insert((211, TokenType::Identifier), ActionNode{action: ParserAction::Reduce, value: 56});
		self.action.insert((211, TokenType::Subtract), ActionNode{action: ParserAction::Reduce, value: 56});
		self.action.insert((211, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Reduce, value: 56});
		self.action.insert((211, TokenType::Term), ActionNode{action: ParserAction::Reduce, value: 56});
		self.action.insert((211, TokenType::Newline), ActionNode{action: ParserAction::Reduce, value: 56});
		self.action.insert((212, TokenType::RightCurlyBrace), ActionNode{action: ParserAction::Shift, value: 215});
		self.action.insert((213, TokenType::RightCurlyBrace), ActionNode{action: ParserAction::Shift, value: 216});
		self.action.insert((214, TokenType::StatementConditional3), ActionNode{action: ParserAction::Goto, value: 217});
		self.action.insert((214, TokenType::Else), ActionNode{action: ParserAction::Shift, value: 218});
		self.action.insert((215, TokenType::At), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((215, TokenType::While), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((215, TokenType::For), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((215, TokenType::If), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((215, TokenType::Identifier), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((215, TokenType::Subtract), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((215, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((215, TokenType::Term), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((215, TokenType::Newline), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((215, TokenType::Elif), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((216, TokenType::While), ActionNode{action: ParserAction::Reduce, value: 41});
		self.action.insert((216, TokenType::For), ActionNode{action: ParserAction::Reduce, value: 41});
		self.action.insert((216, TokenType::If), ActionNode{action: ParserAction::Reduce, value: 41});
		self.action.insert((216, TokenType::Identifier), ActionNode{action: ParserAction::Reduce, value: 41});
		self.action.insert((216, TokenType::Subtract), ActionNode{action: ParserAction::Reduce, value: 41});
		self.action.insert((216, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Reduce, value: 41});
		self.action.insert((216, TokenType::Term), ActionNode{action: ParserAction::Reduce, value: 41});
		self.action.insert((216, TokenType::Newline), ActionNode{action: ParserAction::Reduce, value: 41});
		self.action.insert((216, TokenType::Elif), ActionNode{action: ParserAction::Reduce, value: 41});
		self.action.insert((217, TokenType::While), ActionNode{action: ParserAction::Reduce, value: 42});
		self.action.insert((217, TokenType::For), ActionNode{action: ParserAction::Reduce, value: 42});
		self.action.insert((217, TokenType::If), ActionNode{action: ParserAction::Reduce, value: 42});
		self.action.insert((217, TokenType::Identifier), ActionNode{action: ParserAction::Reduce, value: 42});
		self.action.insert((217, TokenType::Subtract), ActionNode{action: ParserAction::Reduce, value: 42});
		self.action.insert((217, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Reduce, value: 42});
		self.action.insert((217, TokenType::Term), ActionNode{action: ParserAction::Reduce, value: 42});
		self.action.insert((217, TokenType::Newline), ActionNode{action: ParserAction::Reduce, value: 42});
		self.action.insert((217, TokenType::Elif), ActionNode{action: ParserAction::Reduce, value: 42});
		self.action.insert((218, TokenType::LeftCurlyBrace), ActionNode{action: ParserAction::Shift, value: 219});
		self.action.insert((219, TokenType::StatementSuiteFunction), ActionNode{action: ParserAction::Goto, value: 220});
		self.action.insert((219, TokenType::StatementListFunction), ActionNode{action: ParserAction::Goto, value: 94});
		self.action.insert((219, TokenType::StatementLimited), ActionNode{action: ParserAction::Goto, value: 95});
		self.action.insert((219, TokenType::StatementSimple), ActionNode{action: ParserAction::Goto, value: 96});
		self.action.insert((219, TokenType::StatementComplex), ActionNode{action: ParserAction::Goto, value: 97});
		self.action.insert((219, TokenType::StatementExpression), ActionNode{action: ParserAction::Goto, value: 98});
		self.action.insert((219, TokenType::StatementAssignment), ActionNode{action: ParserAction::Goto, value: 99});
		self.action.insert((219, TokenType::StatementConditional), ActionNode{action: ParserAction::Goto, value: 100});
		self.action.insert((219, TokenType::StatementLoop), ActionNode{action: ParserAction::Goto, value: 101});
		self.action.insert((219, TokenType::StatementExpression2), ActionNode{action: ParserAction::Goto, value: 104});
		self.action.insert((219, TokenType::Identifier), ActionNode{action: ParserAction::Shift, value: 102});
		self.action.insert((219, TokenType::If), ActionNode{action: ParserAction::Shift, value: 108});
		self.action.insert((219, TokenType::StatementLoopFor), ActionNode{action: ParserAction::Goto, value: 109});
		self.action.insert((219, TokenType::StatementLoopWhile), ActionNode{action: ParserAction::Goto, value: 110});
		self.action.insert((219, TokenType::StatementExpression3), ActionNode{action: ParserAction::Goto, value: 106});
		self.action.insert((219, TokenType::For), ActionNode{action: ParserAction::Shift, value: 111});
		self.action.insert((219, TokenType::While), ActionNode{action: ParserAction::Shift, value: 112});
		self.action.insert((219, TokenType::Term), ActionNode{action: ParserAction::Shift, value: 107});
		self.action.insert((219, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Shift, value: 103});
		self.action.insert((219, TokenType::Subtract), ActionNode{action: ParserAction::Shift, value: 105});
		self.action.insert((220, TokenType::RightCurlyBrace), ActionNode{action: ParserAction::Shift, value: 221});
		self.action.insert((221, TokenType::While), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((221, TokenType::For), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((221, TokenType::If), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((221, TokenType::Identifier), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((221, TokenType::Subtract), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((221, TokenType::LeftParenthesis), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((221, TokenType::Term), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((221, TokenType::Newline), ActionNode{action: ParserAction::Reduce, value: 43});
		self.action.insert((221, TokenType::Elif), ActionNode{action: ParserAction::Reduce, value: 43});
                ...
                ParserAction::Reduce => {
                    ...
                    stack.push(goto_action.value);
                    {
                        match action_node.value {
							...
							21 => {
								//NTS_STATEMENT_FUNCTION -> TS_AT TS_IDENTIFIER TS_LEFT_PARENTHESIS NTS_FUNCTION_PARAMS TS_RIGHT_PARENTHESIS TS_LEFT_CURLY_BRACE NTS_STATEMENT_SUITE_FUNCTION TS_RIGHT_CURLY_BRACE
							}
							22 => {
